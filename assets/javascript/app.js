    ...
    $("#searchTerms").on("click", function(event){
        ...
        $.ajax({
            ...
            for(var i = 0; i < 16; i += 3){
                ...
                var divImg1 = $('<div id="' + recipeID + '" class="col s12 m4"><div class="card"><div class="card-image waves-effect waves-block waves-light"><img class="activator" src="' + imageURL + '"></div><div class="card-content"><span class="card-title activator grey-text text-darken-4">' + label + '<i class="material-icons right">more_vert</i></span><p><a href="' + sourceURL + '">Preparation Instructions</a><a data-id="' + recipeID + '" class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add</i></a></p></div><div class="card-reveal"><span class="card-title grey-text text-darken-4">' + label + '<i class="material-icons right">close</i></span><p>Servings: ' + yield + '</p><p>Calories: ' + calories + '</p><p>Dietary Info: ' + dietLabels + '</p><p>Health Consideration: ' + healthLabels + '</p><p>Ingredients: ' + ingredients.join(", ") + '</p><a href="' + sourceURL + '">Preparation Instructions</a></div></div></div>');
                var divImg2 = $('<div id="' + recipeID2 + '" class="col s12 m4"><div class="card"><div class="card-image waves-effect waves-block waves-light"><img class="activator" src="' + imageURL2 + '"></div><div class="card-content"><span class="card-title activator grey-text text-darken-4">' + label2 + '<i class="material-icons right">more_vert</i></span><p><a href="' + sourceURL2 + '">Preparation Instructions</a><a data-id="' + recipeID2 + '" class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add</i></a></p></div><div class="card-reveal"><span class="card-title grey-text text-darken-4">' + label2 + '<i class="material-icons right">close</i></span><p>Servings: ' + yield2 + '</p><p>Calories: ' + calories2 + '</p><p>Dietary Info: ' + dietLabels2 + '</p><p>Health Consideration: ' + healthLabels2 + '</p><p>Ingredients: ' + ingredients2.join(", ") + '</p><a href="' + sourceURL2 + '">Preparation Instructions</a></div></div></div>');
                var divImg3 = $('<div id="' + recipeID3 + '" class="col s12 m4"><div class="card"><div class="card-image waves-effect waves-block waves-light"><img class="activator" src="' + imageURL3 + '"></div><div class="card-content"><span class="card-title activator grey-text text-darken-4">' + label3 + '<i class="material-icons right">more_vert</i></span><p><a href="' + sourceURL3 + '">Preparation Instructions</a><a data-id="' + recipeID3 + '" class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add</i></a></p></div><div class="card-reveal"><span class="card-title grey-text text-darken-4">' + label3 + '<i class="material-icons right">close</i></span><p>Servings: ' + yield3 + '</p><p>Calories: ' + calories3 + '</p><p>Dietary Info: ' + dietLabels3 + '</p><p>Health Consideration: ' + healthLabels3 + '</p><p>Ingredients: ' + ingredients3.join(", ") + '</p><a href="' + sourceURL3 + '">Preparation Instructions</a></div></div></div>');
